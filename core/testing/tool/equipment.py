...
class TestEquipment:
    ...
    def from_environment(cls) -> "TestEquipment":
        from core.testing.runtime.config import equipment_config
...
def _build_relay(name: str, config: Mapping[str, Any]) -> Any:
    from core.testing.tool.relay_tool import get_relay_controller
...
def _build_router(name: str, config: Mapping[str, Any]) -> Any:
    from core.testing.tool.router_tool.router_factory import get_router
...
def _build_attenuator(name: str, config: Mapping[str, Any]) -> Any:
    from core.testing.tool.wifi_lab_tool.lab_device_controller import LabDeviceController
