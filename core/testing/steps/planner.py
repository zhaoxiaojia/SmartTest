...
from core.testing.steps.definitions import ActionPlanContext, get_action
from core.testing.tests import build_declared_case_plan, declared_step_enabled, expand_repeated_steps, resolve_title_placeholders
...
def _load_declared_plan(
    *,
    ...
    if not module_path.exists() and path_text.startswith("testing/"):
        module_path = (root_dir / "core" / path_text).resolve()
