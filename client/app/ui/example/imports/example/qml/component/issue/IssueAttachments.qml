...
ColumnLayout {
    ...
    Rectangle {
        ...
        onDropBorderColorChanged: dashedBorder.requestPaint()
        ...
        Canvas { id: dashedBorder; objectName: "issueAttachmentDashedBorder"; anchors.fill: parent; property color renderedBorderColor: parent.dropBorderColor; onRenderedBorderColorChanged: requestPaint(); onPaint: { var c=getContext("2d"); c.clearRect(0,0,width,height); c.strokeStyle=renderedBorderColor; c.lineWidth=1; c.setLineDash([6,4]); c.strokeRect(1,1,width-2,height-2) } }
