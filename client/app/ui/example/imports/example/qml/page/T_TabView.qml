...
FluScrollablePage{
    ...
    function newTab(){
        tab_view.appendTab("qrc:/example/res/image/app_icon.png",qsTr("Document ")+tab_view.count(),com_page,colors[Math.floor(Math.random() * 8)])
    }
    ...
    function newTab(){
        tab_view.appendTab("qrc:/example/res/image/app_icon.png","Document 1",com_page,argument)
    }
}
'
    }
