...
class FluTheme(QObject):
    ...
    def _refreshColors(self):
        isDark = self._dark()
        self.primaryColor = QColor(0, 229, 255, 255) if isDark else QColor(0, 178, 255, 255)
        self.backgroundColor = QColor(8, 12, 16, 255) if isDark else QColor(255, 255, 255, 255)
        self.dividerColor = QColor(0, 229, 255, 46) if isDark else QColor(0, 178, 255, 58)
        self.windowBackgroundColor = QColor(18, 24, 30, 255) if isDark else QColor(255, 255, 255, 255)
        self.windowActiveBackgroundColor = QColor(12, 18, 24, 255) if isDark else QColor(255, 255, 255, 255)
        ...
        self.frameColor = QColor(20, 28, 34, int(255 * 0.9)) if isDark else QColor(255, 255, 255, int(255 * 0.9))
        self.frameActiveColor = QColor(14, 22, 28, int(255 * 0.9)) if isDark else QColor(255, 255, 255, int(255 * 0.92))
        self.itemHoverColor = QColor(0, 229, 255, int(255 * 0.08)) if isDark else QColor(0, 178, 255, int(255 * 0.09))
        self.itemPressColor = QColor(0, 229, 255, int(255 * 0.13)) if isDark else QColor(0, 178, 255, int(255 * 0.14))
        self.itemCheckColor = QColor(0, 229, 255, int(255 * 0.16)) if isDark else QColor(0, 178, 255, int(255 * 0.15))
