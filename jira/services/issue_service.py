...
from jira.fields.extractors import project_fields
from jira.fields.registry import FieldRegistry, build_default_registry
from jira.fields.specs import FieldSpec

if TYPE_CHECKING:
    from jira.transport.client import JiraClient
