...
REQUIRED_TRANSLATIONS = {
    ...
    "TestPageBridge": {
        ...
        "test.env.relay.label",
        "test.env.relay.snmp_pdu.ip.description",
        "test.env.relay.snmp_pdu.ip.label",
        "test.env.relay.snmp_pdu.port.label",
        "test.env.relay.type.snmp_pdu",
        "test.env.relay.type.usb_relay",
        "test.env.relay.usb_relay.mode.label",
        "test.env.relay.usb_relay.port.description",
        "test.env.relay.usb_relay.port.label",
        "test.env.relay.usb_relay.press_seconds.label",
        "test.param.ac_onoff.bt_target.description",
        "test.param.ac_onoff.bt_target.label",
        "test.param.ac_onoff.cycle_count.description",
        "test.param.ac_onoff.cycle_count.label",
        "test.param.ac_onoff.ping_target.description",
        "test.param.ac_onoff.ping_target.label",
        "test.param.ac_onoff.power_off_sec.description",
        "test.param.ac_onoff.power_off_sec.label",
        "test.param.ac_onoff.power_off_step_sec.description",
        "test.param.ac_onoff.power_off_step_sec.label",
        "test.param.ac_onoff.power_on_wait_sec.description",
        "test.param.ac_onoff.power_on_wait_sec.label",
        "test.param.ac_onoff.power_on_wait_step_sec.description",
        "test.param.ac_onoff.power_on_wait_step_sec.label",
        "test.param.auto_reboot.bt_target.description",
        "test.param.auto_reboot.bt_target.label",
        "test.param.auto_reboot.cycle_count.description",
        "test.param.auto_reboot.cycle_count.label",
        "test.param.auto_reboot.interval_sec.description",
        "test.param.auto_reboot.interval_sec.label",
        "test.param.auto_reboot.ping_target.description",
        "test.param.auto_reboot.ping_target.label",
        "test.param.auto_suspend.bt_target.description",
        "test.param.auto_suspend.bt_target.label",
        "test.param.auto_suspend.cycle_count.description",
        "test.param.auto_suspend.cycle_count.label",
        "test.param.auto_suspend.interval_sec.description",
        "test.param.auto_suspend.interval_sec.label",
        "test.param.auto_suspend.ping_target.description",
        "test.param.auto_suspend.ping_target.label",
        "test.param.bt_onoff_scan.bt_target.description",
        "test.param.bt_onoff_scan.bt_target.label",
        "test.param.bt_onoff_scan.cycle_count.description",
        "test.param.bt_onoff_scan.cycle_count.label",
        "test.param.cpu_frequency.frequencies.description",
        "test.param.cpu_frequency.frequencies.label",
        "test.param.dut.description",
        "test.param.dut.label",
        "test.param.emmc_rw.loop_count.description",
        "test.param.emmc_rw.loop_count.label",
        "test.param.emmc_rw.min_free_kb.description",
        "test.param.emmc_rw.min_free_kb.label",
        "test.param.emmc_rw.source_profile.description",
        "test.param.emmc_rw.source_profile.label",
        "test.param.emmc_rw.source_size_kb.description",
        "test.param.emmc_rw.source_size_kb.label",
        "test.param.emmc_rw.work_dir.description",
        "test.param.emmc_rw.work_dir.label",
        "test.param.local_playback_stress.action_interval_sec.description",
        "test.param.local_playback_stress.action_interval_sec.label",
        "test.param.local_playback_stress.actions.description",
        "test.param.local_playback_stress.actions.label",
        "test.param.local_playback_stress.loop_count.description",
        "test.param.local_playback_stress.loop_count.label",
        "test.param.local_playback_stress.media_dir.description",
        "test.param.local_playback_stress.media_dir.label",
        "test.param.local_playback_stress.media_files.description",
        "test.param.local_playback_stress.media_files.label",
        "test.param.local_playback_stress.random_playback.description",
        "test.param.local_playback_stress.random_playback.label",
        "test.param.local_playback_stress.start_wait_sec.description",
        "test.param.local_playback_stress.start_wait_sec.label",
        "test.param.scope.case",
        "test.param.scope.case_type_shared",
        "test.param.scope.global_context",
        "test.param.wifi_onoff_scan.cycle_count.description",
        "test.param.wifi_onoff_scan.cycle_count.label",
        "test.param.wifi_onoff_scan.ping_target.description",
        "test.param.wifi_onoff_scan.ping_target.label",
        "test.schema.case_type_default.title",
        "test.schema.global_context.title",
    },
    "T_Report": {
        "Report",
        "Reports",
