...
from testing.params.contracts import all_param_contracts, case_param_keys
...
from testing.tests.android.common.iptv.middle_screen_runner import assert_middle_screen_objective
...
def test_middle_screen_catalog_is_split_into_exactly_33_test_modules() -> None:
    root = __import__("pathlib").Path("testing/tests/android/common/iptv")
