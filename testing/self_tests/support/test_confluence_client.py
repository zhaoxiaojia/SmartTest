...
from support.confluence_integration.client import ConfluenceClient
from support.confluence_integration.models import ConfluenceClientConfig
...
def test_password_never_leaks_from_construction_failure(monkeypatch):
    ...
    monkeypatch.setattr("support.confluence_integration.client.Confluence", Broken)
