...
from testing.tool.connect_tool.duts.dut import dut
...
from testing.tool.connect_tool.transports.telnet_tool import TelnetSession
from testing.tool.connect_tool.transports.serial_tool import SerialShellExecutor
