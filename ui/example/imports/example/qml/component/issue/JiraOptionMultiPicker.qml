...
ColumnLayout {
    ...
    spacing: 2
    Rectangle {
        Layout.fillWidth: true; implicitHeight: selectedText.implicitHeight + 16; radius: 4
        color: FluTheme.dark ? "#2B2B2B" : "#FFFFFF"
        border.color: FluTheme.dark ? "#666666" : "#A0A0A0"
        FluText { id: selectedText; anchors.left: parent.left; anchors.right: chevron.left; anchors.leftMargin: 10; anchors.rightMargin: 6; anchors.verticalCenter: parent.verticalCenter; text: root.selectedLabels() || root.placeholderText; elide: Text.ElideRight }
    ...
    Rectangle {
        ...
        Layout.preferredHeight: Math.min(200, Math.max(36, (root.options || []).length * (selectedText.implicitHeight + 16)))
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                width: ListView.view.width; height: selectedText.implicitHeight + 16; color: mouse.containsMouse ? (FluTheme.dark ? "#3A3A3A" : "#F1F1F1") : "transparent"
            ...
            ScrollBar.vertical: FluScrollBar { interactive: true; policy: ScrollBar.AsNeeded }
        }
    }
