...
fun CasesScreen(
    ...
    selectedCases: List<CaseTemplate>,
    ...
    Surface(shadowElevation = 10.dp) {
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = stringResource(R.string.cases_selected_count, selectedCount),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.SemiBold,
                )
                Text(
                    text = if (selectedCount == 0) {
                        stringResource(R.string.cases_start_hint_idle)
                    } else {
                        stringResource(R.string.cases_start_hint_ready)
                    },
            ...
            Button(
                onClick = onStartRun,
                text = stringResource(R.string.cases_start_run),
...
private fun SelectedQueueCard(
    ...
    BasicCard(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.cases_selected_queue),
                style = MaterialTheme.typography.titleMedium,
                fontWeight = FontWeight.SemiBold,
            )
            selectedCases.forEachIndexed { index, case ->
                Surface(
    ...
    BasicCard(
        ...
        Column(
            ...
            Row(
                ...
                TokenPill(
                    text = stringResource(R.string.cases_category_count, category.cases.size),
